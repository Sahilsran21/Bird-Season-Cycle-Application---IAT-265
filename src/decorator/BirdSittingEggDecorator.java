...
public class BirdSittingEggDecorator extends NestDecorator {
...
//Methods	
	...
	public void drawNest(Graphics2D g2) {
			...
			//Draw the second bird sitting egg decorator
...
//Constructor
		public BirdSittingEggDecorator(NestInterface NestDecorator) {
